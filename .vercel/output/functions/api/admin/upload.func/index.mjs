...
import { c as toEventHandler, i as defineLazyEventHandler, n as HTTPError, t as H3Core, u as NodeResponse } from "./_libs/h3+rou3+srvx.mjs";
...
var _lazy_Kv4Htm = defineLazyEventHandler(() => import("./_routes/api/admin/content.mjs"));
var _lazy_aL0FQ9 = defineLazyEventHandler(() => import("./_routes/api/admin/login.mjs"));
var _lazy_dNrU9S = defineLazyEventHandler(() => import("./_routes/api/admin/session.mjs"));
...
var findRoute = /* @__PURE__ */ (() => {
	const $0 = {
		...
		handler: _lazy_Kv4Htm
	}, $1 = {
		route: "/api/admin/login",
		method: "post",
		handler: _lazy_aL0FQ9
	}, $2 = {
		route: "/api/admin/session",
		method: "get",
		handler: _lazy_dNrU9S
	}, $3 = {
		route: "/api/admin/upload",
		method: "post",
		handler: _lazy_S6_vRh
	}, $4 = {
		route: "/api/admin/versions",
		handler: _lazy_u9BjIJ
	}, $5 = {
		route: "/api/content",
		method: "get",
	...
	return (m, p) => {
		if (p.charCodeAt(p.length - 1) === 47) p = p.slice(0, -1) || "/";
		if (p === "/api/admin/content") return { data: $0 };
		else if (p === "/api/admin/login") {
			if (m === "POST") return { data: $1 };
		} else if (p === "/api/admin/session") {
			if (m === "GET") return { data: $2 };
		} else if (p === "/api/admin/upload") {
